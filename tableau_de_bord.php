    ...
    <tr>
        ...
        while ($ligne = mysqli_fetch_assoc($result))
        {
            ...
            <tr>
                ...
                <td><a href="modifier.php"><img src="images/modifier.jpg" width="50px" height="50px"></a></td>
                <td><a href="supprimer.php"><img src="images/supprimer.png" width="50px" height="50px"></a></td>
            </tr>
